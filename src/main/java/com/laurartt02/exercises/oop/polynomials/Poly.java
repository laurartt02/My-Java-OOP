...
public interface Poly {
    ...
    /**
     * Returns a new polynomials which is the derivative of the current object
     * More specifically, the call invoked on object (1), returns the object (2) (1)
     * c_0 + c_1 * x + c_2 * x^2 + (2) c_1 + 2c_2 * x + ... + nc_n * x^(n-1)
